  ...
  return (
    <div className={`${poppins.className}`}>
      <div className="max-w-3xl mx-auto flex flex-col items-center justify-center px-4 md:px-0">
        ...
        <h1 className="text-2xl sm:text-3xl font-semibold text-center bg-gradient-to-r from-slate-900 to-slate-600 dark:from-white dark:to-slate-300 text-transparent bg-clip-text">
          Looking for answer?
        </h1>
        <p className={`sm:text-sm text-xs text-slate-600 dark:text-zinc-100 mt-2 pb-8 text-center`}>
        ...
        {faqs.map((faq, index) => (
          ...
          >
            <div className="flex items-center justify-between">
              <h3 className="text-base font-medium text-[14px] sm:text-[16px] ">
                {faq.question}
              </h3>
              <svg
                width="18"
